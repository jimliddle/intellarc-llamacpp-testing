...
In this repo there is also  a lightweight proxy that routes requests to Ollama style endpoints, allowing Apps that use Ollama tto benefit from the optimized Llamacpp GPU acceleration without changing the application (instructions documented in-situ in the files)
